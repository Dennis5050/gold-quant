...
logging.basicConfig(
    filename=f"{logs_path}/trades.csv",
    level=logging.INFO,
...
while True:
    for symbol in symbols:
        # 1. Fetch the most recent 200 candles (15-min)
        ...
        # 5. Loop over latest signals (can use only last candle for simplicity)
